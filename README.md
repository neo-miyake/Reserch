...
球面座標系におけるカメラ座標(r,&theta;,&phi;)を入力に、その座標からみたときのスペースデブリの画像を生成するネットワーク。  

![球面座標系](https://user-images.githubusercontent.com/95911997/208356263-5b0141a2-f71b-4d6c-87a9-6263931a5631.jpg)  
